...
define( "RECIPIENT_NAME", "Twenteez Sales" ); //UPDATE THIS TO YOUR NAME
define( "RECIPIENT_EMAIL", "sales@twenteez.com" ); //UPDATE THIS TO YOUR EMAIL ID
define( "EMAIL_SUBJECT", "Merchandising Site Contact Form" ); //UPDATE THIS TO YOUR SUBJECT
